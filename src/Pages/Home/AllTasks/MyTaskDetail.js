...
const MyTaskDetail = ({ task }) => {
    ...
    const { taskName, aboutTask, taskDate, taskEmail, userName, taskDescription } = task;
    ...
    return (
        <div>
            ...
            <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div>
                    <button className="inline-flex items-center mr-2 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Date: {taskDate}
